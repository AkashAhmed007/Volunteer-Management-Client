...
const onSubmit =(data)=>{
  const {Thumbnail,Title,Category,Location,volunteers,Deadline,email,name,Description} = data
  const addVolunteerInfo = {Thumbnail,Title,Category,Location,volunteers,Deadline,email,name,Description}
          ...
          <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
            <div className="space-y-2 col-span-full lg:col-span-1 text-white w-3/4">
              ...
              <p className="text-base font-bold">
               Help The Future collects volunteers information in future purpose when need so that we can find you.
              </p>
            </div>
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <div className="col-span-full sm:col-span-3">
                ...
                />
                {errors.volunteers && <span className="text-red-500" >This field is required</span>}
              </div>
              <div className="col-span-full sm:col-span-3">
                <label htmlFor="Deadline" className="text-xl font-bold text-white">
                Deadline
                </label>
                <input
                  name = "Deadline"
